...
class Edge:
    ...
    Attributes:
        ...
        travel_times: Historic average travel times keyed by 15-minute bin
            start (seconds since midnight). Populated by
            ``matsim_io.load_historic_travel_times``; empty until then.
    """
    ...
    def __init__(
        ...
        self.travel_times: Dict[int, float] = {}
